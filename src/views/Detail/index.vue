      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input v-model="value" class="itxt" type="number" @change="changeVal">
                <a class="plus" @click="value++">+</a>
                <a class="mins" @click="value > 1 ? value-- : value = 1">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    ...
    async addshopcar() {
      try {
        await this.$store.dispatch('addOrUpdateShopCart', { skuId: this.$route.params.goodsId, skuNum: this.value })
        sessionStorage.setItem("SKUINFO", JSON.stringify(this.skuInfo))
        this.$router.push({ path: '/addCartSuccess', query: { skuNum: this.value } })
      } catch (error) {
        alert(error.message)
      }
    }
