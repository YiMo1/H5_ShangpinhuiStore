<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address" v-for="address in userAddressList" :key="address.id">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list" v-for="detail in detailArrayList" :key="detail.id">
          <li><img :src="detail.imgUrl"></li>
          <li>
            <p>{{ detail.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
    ...
    <div class="money">
      <ul>
        <li>
          ...
          <span>¥{{ $store.state.trade.tradeInfo.totalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
